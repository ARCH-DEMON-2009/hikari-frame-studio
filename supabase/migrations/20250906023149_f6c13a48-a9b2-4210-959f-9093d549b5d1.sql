...
-- Add new settings for admin management (only if they don't exist)
INSERT INTO public.settings (key, value, description) 
SELECT 'printing_processing_charge', '0', 'Charge for printing and processing (included in frame price)'
WHERE NOT EXISTS (SELECT 1 FROM public.settings WHERE key = 'printing_processing_charge');
